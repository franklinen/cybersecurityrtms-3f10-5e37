[cybersecurityrtms-3f10-5e37] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecurityrtms-3f10-5e37] container is NOT running**.

.. tip::
   You must have your [cybersecurityrtms-3f10-5e37] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42585  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='franklinen'  \-\-env DOCKERUSERNAME='frank19831207'  \-\-env MQTTUSERNAME='franklinen'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/dashboard-rtms.html?topic=rtms-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[cybersecurityrtms-3f10-5e37] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/franklinen/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecurityrtms-3f10-5e37
...
.. important::
   solution_preprocessing_dag-cybersecurityrtms-3f10-5e37
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=43893, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=35807, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=35897, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=39737, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=42121, HPDEHOST=172.17.0.2, HPDEPORT=40895, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=35479

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1364-cybersecurityrtms-3f10-5e37,solution_preprocessing_dag-cybersecurityrtms-3f10-5e37, python-preprocess-8197-cybersecurityrtms-3f10-5e37,solution_preprocessing_dag-cybersecurityrtms-3f10-5e37, python-preprocess3-986-cybersecurityrtms-3f10-5e37,solution_preprocessing_dag-cybersecurityrtms-3f10-5e37, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
